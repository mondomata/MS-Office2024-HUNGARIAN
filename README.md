...
<quote>
 Nyissa meg a PowerShellt (nem CMD-t).  Ehhez kattintson a jobb gombbal a Windows Start menüjére (vagy nyomja egyszerre a Windows🪟 és X billentyűket), és válassza a PowerShell vagy a Terminál lehetőséget.
